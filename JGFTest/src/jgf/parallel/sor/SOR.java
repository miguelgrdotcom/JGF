 ...
 * Centre * * email: epcc-javagrande@epcc.ed.ac.uk * * adapted from SciMark 2.0,
 * author Roldan Pozo (pozo@cam.nist.gov) * * This version copyright (c) The
 * University of Edinburgh, 2001. * All rights reserved. * *
 * ************************************************************************
 */
package jgf.parallel.sor;
