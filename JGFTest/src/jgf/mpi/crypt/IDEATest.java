...
public void cipher_idea(byte [] text1, byte [] text2, int [] key, int length)
...
for (int i = 0; i < text1.length; i += 8)
{
    ...
    HUKernel(i, JGFCryptBench.rank, length);
}   // End for loop.

}   // End routine.

public void HUKernel(int i, int rank, int length) {
    return;
}
