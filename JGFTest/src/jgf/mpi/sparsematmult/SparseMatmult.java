 ...
 * * email: epcc-javagrande@epcc.ed.ac.uk * * adapted from SciMark 2.0, author
 * Roldan Pozo (pozo@cam.nist.gov) * * This version copyright (c) The University
 * of Edinburgh, 2001. * All rights reserved. * *
*************************************************************************
 */
package jgf.mpi.sparsematmult;
...
public class SparseMatmult {
    ...
    public static void test(double y[], double val[], int row[],
        ...
        for (int reps = 0; reps < NUM_ITERATIONS; reps++) {
            for (int i = 0; i < nz; i++) {
                ...
                HUKernel(i, JGFSparseMatmultBench.rank, nz);
    ...
    private static void HUKernel(int i, int rank, int size) {
        return;
    }
}
